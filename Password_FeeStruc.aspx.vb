...
Partial Class Password_FeeStruc
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            ElseIf TextBox1.Text <> "" Then
                ...
                Response.Write("<script>    window.location.href = 'Password_FeeStruc.aspx' </script>")
            Else
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Session("pwdFeeStruc") = Nothing
        ' Session("check1") = 3
        Response.Write("<script>window.location.href = 'fee_Master1.aspx' </script>") 'Response.Redirect("Session_1_Page_1.aspx")
    End Sub
